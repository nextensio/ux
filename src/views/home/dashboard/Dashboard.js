  ...
  return (
    <>
      ...
      <CRow className="d-flex justify-content-between">
        ...
        <CCol xs="12" sm="6" lg="3">
          <CWidgetIcon text="GBs Reduced" header="4,400 GBs" color="primary" iconPadding={false}>
            <CIcon width={24} name="cil-laptop"/>
          </CWidgetIcon>
        </CCol>
        <CCol xs="12" sm="6" lg="3">
          <CWidgetIcon text="New Requests" header="4" color="primary" iconPadding={false}>
