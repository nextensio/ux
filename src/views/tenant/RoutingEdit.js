...
const PolicyEdit = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(common.api_href('/api/v1/addroute'), requestOptions)
            .then(async response => {
        ...
        <CCard>
            ...
            <CCardBody>
                <CForm>
                    ...
                    <CFormGroup>
                        <CLabel htmlFor="nf-email">Route Tag</CLabel>
                        <CInput name="tag" placeholder={userData.tag} onChange={handleChange} />
                    </CFormGroup>
                </CForm>
            </CCardBody>
            <CCardFooter>
