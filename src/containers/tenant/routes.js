...
const Advanced = React.lazy(() => import('../../views/tenant/home/Advanced'));
...
const Help = React.lazy(() => import('../../views/tenant/Help'));

const routes = [
    { path: '/tenant/:id/:group', exact: true },
    { path: '/tenant/:id/:group/advanced', name: 'Advanced', component: Advanced },
    ...
    { path: '/tenant/:id/:group/help', name: 'Help', component: Help },
];
